...
<p:declare-step name="catalog-year" type="nlb:catalog-year" xmlns:p="http://www.w3.org/ns/xproc" xmlns:cx="http://xmlcalabash.com/ns/extensions" xmlns:dtbook="http://www.daisy.org/z3986/2005/dtbook/"
    ...
    xmlns:opf="http://www.idpf.org/2007/opf" exclude-inline-prefixes="#all" version="1.0" xpath-version="2.0">
    ...
    <p:store doctype-public="-//NISO//DTD dtbook 2005-3//EN" doctype-system="http://www.daisy.org/z3986/2005/dtbook-2005-3.dtd" name="store.dtbook" cx:depends-on="store.norbraille">
    ...
    <px:mkdir name="mkdir.html" cx:depends-on="store.dtbook">
    ...
    <p:identity cx:depends-on="resource.4">
        <p:input port="source">
            <p:pipe port="result" step="dtbook"/>
        </p:input>
    </p:identity>
